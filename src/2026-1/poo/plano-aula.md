---
name: Plano de Aula - Programação Orientada a Objetos
date: 2026-02-06
---
...
## Ementa
Introdução à programação orientada a objetos, abstração, classes, atributos, métodos, encapsulamento, polimorfismo,
herança, interface, mensagem e tratamento de exceções.

## Objetivo geral
Habilitar o acadêmico a compreender e aplicar os fundamentos do paradigma de programação orientada a objetos (POO) na
resolução de problemas complexos, utilizando abstrações para modelar e desenvolver sistemas de software que sejam
modulares e de manutenção facilitada.
...
## Metodologia
Aulas expositivas e dialogadas e desenvolvimento e apresentação de um projeto que aplique os conceitos de orientação a
objetos.
